...
| Bar tape primitive | Primitive and compound files | `src/components/primatives/BarTape.vue` | Stable anatomy; copied into compounds | recommended pending extraction |
...
|---|---|---|---|---|
| Full run scope and first extraction order | `SCOPE_GATE.md` | Accept `BarTape` first or redirect | Scope/Taxonomy Gate | pending |
...
| Bar-tape major proportions | Primitive and compound files | Correct interval/proportion grammar | Promotion Gate | pending before extraction |
...
|---|---|---|
| `PrimitiveBarTape.vue` / compounds | Generic music colors exist, but segment/proportion/playhead/downbeat grammar is local and duplicated | Extract BarTape and decide major proportions. |
...
|---|---|---|---|---|---:|
| First extraction slice | Taxonomy Gate / Promotion Gate | user | 2026-05-24 | Accept `BarTape` or choose alternative | yes, docs only; no extraction beyond chosen slice |
