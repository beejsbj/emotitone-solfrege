...
| Spine Card | Source and guide specimen exist; the unit is being reworked in a separate lane | Do not redesign Spine Card in the Marks pass. Its current `Kicker.vue` import may remain as a thin compatibility adapter that directly composes Mark and Sticker until the owning lane removes it |
