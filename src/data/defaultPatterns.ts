...
function createSolfegeData(name: string): SolfegeData {
  return {
    name,
    chromatic: name,
    primaryColor: 'hsl(0, 0%, 50%)',
    lightColor: 'hsl(0, 0%, 70%)',
    darkColor: 'hsl(0, 0%, 30%)',
    noteHeads: []
  }
}
...
function getSolfegeScaleDegree(solfege: string): number {
  const degreeMap: Record<string, number> = {
    'Do': 1, 'Ra': 2, 'Re': 2, 'Me': 3, 'Mi': 3,
    'Fa': 4, 'Fi': 5, 'Sol': 5, 'Le': 6, 'La': 6,
    'Te': 7, 'Ti': 7,
    'C4': 1, 'D4': 2, 'E4': 3, 'F4': 4, 'G4': 5, 'A4': 6, 'B4': 7,
    'C5': 1, 'D5': 2, 'E5': 3, 'F5': 4, 'G5': 5, 'A5': 6, 'B5': 7,
    'C#5': 1, 'D#4': 2, 'D#5': 2, 'F#4': 4, 'F#5': 4, 'G#4': 5, 'A#4': 6
  }
...
function getSolfegeIndex(solfege: string): number {
  const indexMap: Record<string, number> = {
    'Do': 0, 'Ra': 1, 'Re': 1, 'Me': 2, 'Mi': 2,
    'Fa': 3, 'Fi': 4, 'Sol': 4, 'Le': 5, 'La': 5,
    'Te': 6, 'Ti': 6,
    'C4': 0, 'D4': 1, 'E4': 2, 'F4': 3, 'G4': 4, 'A4': 5, 'B4': 6,
    'C5': 0, 'D5': 1, 'E5': 2, 'F5': 3, 'G5': 4, 'A5': 5, 'B5': 6,
    'C#5': 0, 'D#4': 1, 'D#5': 1, 'F#4': 3, 'F#5': 3, 'G#4': 4, 'A#4': 5
  }
 ...
 */
export function getDefaultPatternsByType(patternType: Pattern['patternType']): Pattern[] {
