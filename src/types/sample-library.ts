...
export interface SampleLibrary {
   ...
   */
  load(options?: SampleLibraryLoadOptions): Tone.Sampler | Record<string, Tone.Sampler>
}
 ...
 */
export type SampleInstrumentCategory = 'strings' | 'brass' | 'woodwinds' | 'keyboards' | 'percussion'
