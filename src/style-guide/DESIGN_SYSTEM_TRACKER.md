...
| Kicker + Spine Card | Kicker remains a lower primitive; Burooj classified Spine Card as a Card variant rather than a separate shell family | After Card acceptance, make Spine Card compose Card while preserving its one-brand-color spine, Kicker, stamp, and body recipe before Loading Screen closure |
