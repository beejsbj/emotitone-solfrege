...
| **Instrument Picker** | Instrument-selection content inside the shared top Drawer | Drawer and Tabs are closed; define and adopt the interior, considering Sticker/Badge placements before composition review |
...
5. **Top-menu definition:** with Tabs closed, compare Instrument and Config interiors against `/style-guide/`; define the remaining interior grammar and decide Sticker/Badge placement without redesigning behavior.
