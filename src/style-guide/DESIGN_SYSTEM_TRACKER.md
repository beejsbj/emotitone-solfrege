...
3. **Pattern List:** define the list/stack compound around the closed Pattern Card source, mount a real controlled specimen, and preserve production store ownership and loading behavior.
