export interface InstrumentCategory {
  name: string;
  instruments: string[];
  preload: string[]; // Curated candidates; startup currently warms only triangle.
}
...
export const INSTRUMENT_CATEGORIES: InstrumentCategory[] = [
  ...
  },
  {
    ...
    instruments: [
      ...
      'gm_overdriven_guitar', 'gm_guitar_harmonics',
  ...
  },
  {
    ...
    instruments: [
      ...
      'gm_accordion', 'gm_bagpipe', 'gm_bandoneon',
      'gm_tinkle_bell',
    ],
  ...
  },
  {
    ...
    instruments: [
      ...
      'gm_synth_choir',
      'pulse', 'saw', 'sawtooth', 'sin', 'sine', 'sqr', 'square',
      'supersaw', 'tri', 'triangle',
    ],
