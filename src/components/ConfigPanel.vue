          ...
          <div class="mb-5 pb-4 border-b border-neutral-700">
            <div class="mb-2.5">
              ...
              >
                ...
                />
                <span
                  class="relative w-10 h-5 rounded-full border transition-colors before:content-[''] before:absolute before:w-4 before:h-4 before:rounded-full before:top-0.5 before:transition-transform"
                  :class="visualsEnabled
                    ? 'bg-[#00ff88]/80 border-[#00ff88] before:bg-white before:translate-x-5 before:left-0.5'
                    : 'bg-neutral-700 border-neutral-600 before:bg-neutral-400 before:left-0.5'"
                ></span>
                Enable All Visuals
              </label>
            </div>
